...
$query = "SELECT id, productType, inventory, model, brand, title, description, price, serialnumber, releaseDate, processor, ram, storage, os, screenSize, img FROM product $clause where productType='laptop'";
        ...
        <div class="card">
          ...
          <div class="card-body" style="margin:auto;">
            ...
            <ul>
              ...
              <li>Taille d'écran: <?php echo $row["screenSize"] . " Pouces "; ?></li>
